...
@section('content')
    ...
    <form id="create-courier-form" onsubmit="return false;" class="space-y-4 bg-white p-6 rounded shadow-md">
        ...
        <div>
            ...
            <input type="text" name="first_name" value="{{ old('first_name') }}" class="w-full p-2 border rounded">
            <div class="text-red-500 text-sm mt-1" id="error_first_name"></div>
        </div>

        <div>
            <label class="block mb-1">Last Name</label>
            <input type="text" name="last_name" value="{{ old('last_name') }}" class="w-full p-2 border rounded">
